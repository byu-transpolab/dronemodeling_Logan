...
if __name__ == "__main__":
    ...
    config = {
        # Inputs
        "geojson_path": PROJECT_ROOT / "buildingfootprint" / "provo_orem_area"/ "orem_caschade_orchard.geojson", #update this path for different cities
        ...
        "annotation_dir": "/Users/willicon/Desktop/orem_caschade_seed15/labels"    ,  #None, # e.g., PROJECT_ROOT / "valid" / "labels",
